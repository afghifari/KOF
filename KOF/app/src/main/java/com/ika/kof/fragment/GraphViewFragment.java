...
/**
 * Created and edited by Alhudaghifari on 7/31/2017.
...
public class GraphViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.graphview_fragment, container, false);
    ...
    public void inisialisasiDataAwal() {
        ...
        dataGraphic = new DataGraphic(GraphViewFragment.this.getActivity());
    }
...
//        graph.addSeries(series2);
    ...
    private void showToast(String message) {
        Toast.makeText(GraphViewFragment.this.getActivity(),message,Toast.LENGTH_LONG).show();
    }
}
